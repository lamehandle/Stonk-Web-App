...
if set_take_profit.capitalize() == 'Y':
    ...
    # merge "comp_hist_df" dataframe with the "stop_loss_df" dataframe to return teh intersection of the dataframes
    #   will need to allow for greater than and less than logic
